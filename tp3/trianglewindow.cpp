...
void  TriangleWindow::update_season()
{
    day = (day + 1) %    365;

    if (day<80) {season = Winter; return;} // until March 21
    if (day<172) {season = Spring; return;} // until June 21
    if (day <264) {season = Summer; return;} // until September 21
    if (day < 356) {season = Autumn; return;}//until December 21
